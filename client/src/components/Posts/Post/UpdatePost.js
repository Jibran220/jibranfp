                            ...
                            <Card.Body>
                                <Form id="form-wizard1" className="text-center mt-3"  onSubmit={handleSubmit}>
                                        ...
                                        <div className="form-card text-start">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <input type="text" className="form-control" value={postData.Product_Name} onChange={(e) => setPostData({ ...postData, Product_Name: e.target.value })} />
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-group">
                                    ...
                                    <select  className="form-select mb-3 shadow-none"value={postData.Product_Category} onChange={(e) => setPostData({ ...postData, Product_Category: e.target.value })}>
                                        ...
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Household} onChange={(e) => setPostData({ ...postData, Household: e.target.checked })}  id="1"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Household
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox"  checked={postData.Commercial} onChange={(e) => setPostData({ ...postData, Commercial: e.target.checked })} id="2"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Commercial
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox"checked={postData.Clinical}onChange={(e) => setPostData({ ...postData, Clinical: e.target.checked })}id="3"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Clinical
                                        </Form.Check.Label>
                                    </Form.Check>
                                        ...
                                        <option value="IEC 60086-4:2015">IEC 60086-4:2015</option>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='Yes' onChange={(e) => setPostData({ ...postData, TradeMark: e.target.value })} name="c" id="26"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                            Yes
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='No' onChange={(e) => setPostData({ ...postData, TradeMark: e.target.value })} name="c" id="27"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                          No
                                        </Form.Check.Label>
                                    </Form.Check>
                                        ...
                                        <option value="mtr">mtr</option>
                                            ...
                                            <div className="col-md-4">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='Continuos' onChange={(e) => setPostData({ ...postData,Operation_Mode : e.target.value })} name="1" id="28" />
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                        Continuos
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='  Duty Cycle' onChange={(e) => setPostData({ ...postData, Operation_Mode: e.target.value })} name="1" id="29"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                        Duty Cycle
                                        </Form.Check.Label>
                                    </Form.Check>                                                </div>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Ordinary_person} onChange={(e) => setPostData({ ...postData, Ordinary_person: e.target.checked })}  id="6"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Ordinary person
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Children_likely_present} onChange={(e) => setPostData({ ...postData, Children_likely_present: e.target.checked })}  id="7"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Children likely present
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Instructed_person} onChange={(e) => setPostData({ ...postData, Instructed_person: e.target.checked })} id="8"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
Instructed person
                                     </Form.Check.Label>
                                    </Form.Check>      
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Skilled_person} onChange={(e) => setPostData({ ...postData, Skilled_person: e.target.checked })}  id="9"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Skilled person                                        </Form.Check.Label>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.AC_mains} onChange={(e) => setPostData({ ...postData, AC_mains: e.target.checked })}  id="10"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        AC mains
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.DC_mains} onChange={(e) => setPostData({ ...postData, DC_mains: e.target.checked })}  id="11"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        DC mains
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Battery_Powered} onChange={(e) => setPostData({ ...postData, Battery_Powered: e.target.checked })}  id="12"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Battery Powered
                                     </Form.Check.Label>
                                    </Form.Check>      
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Non_detachable_Supply_Cord} onChange={(e) => setPostData({ ...postData, Non_detachable_Supply_Cord: e.target.checked })}  id="13"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Non-detachable Supply Cord
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Appliance_Coupler} onChange={(e) => setPostData({ ...postData, Appliance_Coupler: e.target.checked })}  id="14"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Appliance Coupler
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Direct_plug_in} onChange={(e) => setPostData({ ...postData, Direct_plug_in: e.target.checked })}  id="15"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Direct plug-in
                                     </Form.Check.Label>
                                    </Form.Check>      
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Non_detachable_Supply_Cord_B} onChange={(e) => setPostData({ ...postData, Non_detachable_Supply_Cord_B: e.target.checked })}  id="16"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Non-detachable Supply Cord B                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Appliance_Coupler_B} onChange={(e) => setPostData({ ...postData, Appliance_Coupler_B: e.target.checked })}  id="17"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Appliance Coupler B
                                        </Form.Check.Label>
                                    </Form.Check>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Permanent_connection} onChange={(e) => setPostData({ ...postData, Permanent_connection: e.target.checked })}  id="18"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Permanent connection
                                     </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Mating_connector} onChange={(e) => setPostData({ ...postData, Mating_connector: e.target.checked })}  id="19"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Mating connector
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Movable} onChange={(e) => setPostData({ ...postData, Movable: e.target.checked })}  id="20"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Movable
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Transportable} onChange={(e) => setPostData({ ...postData, Transportable: e.target.checked })}  id="21"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Transportable
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Stationary_for_building_in} onChange={(e) => setPostData({ ...postData, Stationary_for_building_in: e.target.checked })}  id="22"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Wall_ceiling_mounted_SRME_rack_mounted} onChange={(e) => setPostData({ ...postData, Wall_ceiling_mounted_SRME_rack_mounted: e.target.checked })}  id="23"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Hand_held} onChange={(e) => setPostData({ ...postData, Hand_held: e.target.checked })}  id="24"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Hand-held
                                        ...
                                        <div className="form-card text-start">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='P1' onChange={(e) => setPostData({ ...postData, Pollution_Degree: e.target.value })} name="a" id="30"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                      P1
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='P2' onChange={(e) => setPostData({ ...postData, Pollution_Degree: e.target.value })} name="a" id="31"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                               P2
                                        </Form.Check.Label>
                                    </Form.Check>    
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='P3' onChange={(e) => setPostData({ ...postData, Pollution_Degree: e.target.value })} name="a" id="32"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                               P3
                                        </Form.Check.Label>
                                    </Form.Check>                                              </div>
                                            ...
                                            <div className="col-md-3">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Indoor} onChange={(e) => setPostData({ ...postData, Indoor: e.target.checked })}  id="256"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Indoor
                                        </Form.Check.Label>
                                    </Form.Check>
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"   type="checkbox" checked={postData.Outdoor} onChange={(e) => setPostData({ ...postData, Outdoor: e.target.checked })}  id="25"/>
                                        <Form.Check.Label  htmlFor="flexCheckDefault">
                                        Outdoor
                                   ...
                                   <fieldset className={`${show === 'Image' ? 'd-block' : 'd-none'}`}>
                                        ...
                                        {/* <Form.Control  type="file" id="customFile1"/> */}
                                            ...
                                            <div className="col-md-4">
                                                <div className="form-group">
                                                    ...
                                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='Replaceable' onChange={(e) => setPostData({ ...postData, Fuse_Type: e.target.value })} name="b" id="33"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                        Replaceable
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='Non-Replaceable' onChange={(e) => setPostData({ ...postData, Fuse_Type: e.target.value })} name="b" id="34"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                        Non-Replaceable
                                    ...
                                    <Form.Check className="d-block">
                                        <Form.Check.Input className="me-2"  type="radio" value='None' onChange={(e) => setPostData({ ...postData, Fuse_Type: e.target.value })} name="b" id="35"/>
                                        <Form.Check.Label  htmlFor="flexRadioDefault1">
                                        None
