            ...
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                <div>
                    ...
                    <div>
                        ...
                        <div class="col-md-4">
                            <label for="inputState" class="form-label">Vendor Details
                            </label>
                            <input type="text" class="form-control" id="inputEmail4" value={postData.vendordetails} onChange={(e) => setPostData({ ...postData, vendordetails: e.target.value })} />
                        ...
                        <div class="col-md-4">
                            ...
                            <label for="inputState" class="form-label">any_other_instructions_for_quoting
                            </label>
                            <input type="text" class="form-control" id="inputEmail4" value={postData.any_other_instructions_for_quoting} onChange={(e) => setPostData({ ...postData, any_other_instructions_for_quoting: e.target.value })} />



                        </div> <div class="col-md-4">
                            <label for="inputState" class="form-label">statement_for_qualification
                            </label>
                            <input type="text" class="form-control" id="inputEmail4" value={postData.statement_for_qualification} onChange={(e) => setPostData({ ...postData, statement_for_qualification: e.target.value })} />
