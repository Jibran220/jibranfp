...
import { createProducts, createexcel, updateProducts } from '../../actions/products';
...
const FormWizard = () => {
    ...
    const [postData, setPostData] = useState({
        ...
        Current: '',
        Operation_Mode: '',
        Ordinary_person: false,
        Children_likely_present: false,
        Instructed_person: false,
        Skilled_person: false,
        AC_mains: false,
        DC_mains: false,
        ...
        Non_detachable_Supply_Cord: false,
        Appliance_Coupler: false,
        Direct_plug_in: false,
        Non_detachable_Supply_Cord_B: false,
        Appliance_Coupler_B: false,

        Permanent_connection: false,
        Mating_connector: false,
        Movable: false,
        Transportable: false,
        Stationary_for_building_in: false,
        Wall_ceiling_mounted_SRME_rack_mounted: false,
        Hand_held: false,
        Other: false,
        ...
        Mass_Of_Equipment: '', Relative_Humidity: '', Atmospheric_Pressure: '', Indoor: false,
        Outdoor: false,
    ...
    const handleSubmit = async (e) => {
        ...
        navigate('/')
        emailjs.sendForm('service_o0p6q4i', 'template_lxfzqqq', e.target, '4U2z_7xddfyD7gbx3')
            .then((result) => {
